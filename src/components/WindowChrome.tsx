...
export const WindowChrome: React.FC<WindowChromeProps> = ({
  ...
  return (
    <div className="absolute inset-x-0 top-0 z-90 h-14 overflow-hidden rounded-t-[24px] border-b border-white/10 bg-black/35 backdrop-blur-2xl customizable-backdrop-medium">
