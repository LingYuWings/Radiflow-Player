...
import { FolderOpen, FolderPlus, Globe2, Info, Library, Monitor, RefreshCw, Sparkles } from 'lucide-react';
...
const SettingsCard: React.FC<{
  ...
  <section className="rounded-3xl border border-white/10 bg-black/20 backdrop-blur-2xl p-6 md:p-8 shadow-2xl">
